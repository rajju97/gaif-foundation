...
const AdminDashboard = () => {
  ...
  // Consolidate metrics calculation into a single pass over the orders array
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-7 gap-4 mb-6">
        ...
        <div className="bg-surface-lowest p-5 rounded-ds shadow-ambient text-center">
          <p className="text-2xl font-bold text-green-600">&#8377;{metrics.totalRevenue.toFixed(0)}</p>
          <p className="text-sm text-on-surface-variant">Revenue</p>
        </div>
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-orange-600">&#8377;{metrics.totalCommission.toFixed(0)}</p>
          <p className="text-sm text-gray-500">Commission</p>
        </div>
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-teal-600">&#8377;{metrics.totalGst.toFixed(0)}</p>
