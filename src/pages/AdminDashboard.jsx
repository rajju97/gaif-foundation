...
const AdminDashboard = () => {
  ...
  // ⚡ Bolt: Optimize total revenue, commission, and GST calculation.
  // Consolidates 3 passes over the orders array (filter + reduce) into a single pass O(n).
  // Wrapped in useMemo to prevent recalculation on unrelated re-renders (like tab changes).
