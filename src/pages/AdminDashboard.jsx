...
const AdminDashboard = () => {
  ...
  // Bolt Optimization: Calculate all financial metrics in a single O(N) pass to reduce iteration overhead
  ...
  // Bolt Optimization: Memoize sellers array to prevent recalculation on every render
