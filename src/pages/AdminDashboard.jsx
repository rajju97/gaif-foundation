...
const AdminDashboard = () => {
  ...
  // ⚡ Bolt: Consolidate multiple array iterations (filter + reduce) into a single O(N) pass,
  // and wrap in useMemo to prevent recalculating on every re-render (e.g. when typing in GST input)
