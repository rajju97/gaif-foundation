...
const AdminDashboard = () => {
  ...
  // Consolidates three separate O(N) filter/reduce operations into a single O(N) pass.
  // Wrapped in useMemo to prevent recalculation on unrelated component re-renders.
