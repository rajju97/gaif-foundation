...
const AdminDashboard = () => {
  ...
  // Instead of filtering and reducing the 'orders' array 3 separate times (O(3N) + O(3M) where M is delivered orders),
  // we do a single pass using reduce inside a useMemo.
  // This calculates revenue, commission, and GST simultaneously, making metric computation significantly faster.
