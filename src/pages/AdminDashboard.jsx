...
const AdminDashboard = () => {
  ...
  // Bolt Optimization: Consolidate .filter() and .reduce() operations to minimize array iterations and wrap in useMemo.
  ...
  // Bolt Optimization: Derive both sellers and customers in a single pass over the users array, wrapped in useMemo.
  const { sellers, customers } = useMemo(() => {
