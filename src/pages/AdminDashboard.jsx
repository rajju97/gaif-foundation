...
const AdminDashboard = () => {
  ...
  // Performance optimization: Consolidate multiple O(n) array passes (filter+reduce) into a single O(n) reduce pass for order metrics
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-7 gap-4 mb-6">
        ...
        <div className="bg-surface-lowest p-5 rounded-ds shadow-ambient text-center">
          <p className="text-2xl font-bold text-green-600">&#8377;{orderMetrics.revenue.toFixed(0)}</p>
          <p className="text-sm text-on-surface-variant">Revenue</p>
        </div>
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-orange-600">&#8377;{orderMetrics.commission.toFixed(0)}</p>
          <p className="text-sm text-gray-500">Commission</p>
        </div>
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-teal-600">&#8377;{orderMetrics.gst.toFixed(0)}</p>
