...
const AdminDashboard = () => {
  ...
  const { totalRevenue, commission, gstCollected } = useMemo(() => {
      return orders.reduce((acc, o) => {
          if (o.status === 'delivered') {
              acc.totalRevenue += (o.total || 0);
              acc.commission += (o.commissionAmount || 0);
              acc.gstCollected += (o.gstAmount || 0);
          }
          return acc;
      }, { totalRevenue: 0, commission: 0, gstCollected: 0 });
  }, [orders]);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-7 gap-4 mb-6">
        ...
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-orange-600">&#8377;{commission.toFixed(0)}</p>
          <p className="text-sm text-gray-500">Commission</p>
        </div>
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-teal-600">&#8377;{gstCollected.toFixed(0)}</p>
