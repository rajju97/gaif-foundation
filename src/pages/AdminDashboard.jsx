...
const AdminDashboard = () => {
  ...
  // ⚡ Bolt Optimization: Consolidate multiple O(N) array filters into a single O(N) reduce pass.
  // Impact: Reduces iterations over the orders array from 3x to 1x and caches the result across renders.
