...
const AdminDashboard = () => {
  ...
  // Performance Optimization: Consolidate multiple iterations over orders into a single O(N) pass.
  // We use useMemo to prevent recalculation on every render unless 'orders' changes.
  const stats = useMemo(() => {
