  ...
  const orderStats = useMemo(() => {
    return orders.reduce((acc, order) => {
      if (order.status === 'delivered') {
        ...
        acc.gstCollected += (order.gstAmount || 0);
      }
      return acc;
    }, { revenue: 0, commission: 0, gstCollected: 0 });
  }, [orders]);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-7 gap-4 mb-6">
        ...
        <div className="bg-base-100 p-4 rounded-lg shadow text-center">
          <p className="text-2xl font-bold text-teal-600">&#8377;{orderStats.gstCollected.toFixed(0)}</p>
