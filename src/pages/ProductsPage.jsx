...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Memoize product filtering to prevent unnecessary calculations on every re-render.
    // Also, hoist string conversions (.toLowerCase) outside the filter loop to convert O(N) operations to O(1).
