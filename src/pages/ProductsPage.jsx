...
const ProductsPage = () => {
    ...
    // Memoizing the filtered list prevents recalculation of the entire product array
    // on unrelated state changes, like toggling `sidebarOpen`.
    // We also hoist the `.toLowerCase()` calls outside the loop for O(1) string processing overhead.
