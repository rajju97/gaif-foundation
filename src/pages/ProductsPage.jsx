...
const ProductsPage = () => {
    ...
    // Performance Optimization: Wrap derived state in useMemo to prevent synchronous main-thread
    // blocking on every render. Extract invariant computations outside the filter loop to minimize per-item overhead.
