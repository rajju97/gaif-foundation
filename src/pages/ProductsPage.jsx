...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Memoized derived state to prevent expensive array filtering and sorting on every re-render.
    // Impact: Avoids main-thread blocking when unrelated state changes.
    const filteredProducts = useMemo(() => {
        // Extract invariant string derivations outside the loop to reduce per-item overhead.
