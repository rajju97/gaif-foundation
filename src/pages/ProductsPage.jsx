...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Wrap derived state in useMemo to prevent O(N log N) recalculations on unrelated re-renders
    const filteredProducts = useMemo(() => {
        // ⚡ Bolt: Extract invariant string operations outside the O(N) filter loop
