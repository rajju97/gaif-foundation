...
const ProductsPage = () => {
    ...
    // ⚡ Bolt Optimization: Memoize filtering and sorting to prevent blocking main thread on every render
    // Extracted invariant string operations outside the loop for O(n) string manipulation savings.
