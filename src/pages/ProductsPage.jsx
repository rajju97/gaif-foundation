...
const ProductsPage = () => {
    ...
    // Wrap derived filtering and sorting state in useMemo to prevent recalculation
    // on every render and avoid blocking the main thread synchronously.
    const filteredProducts = useMemo(() => {
        // Extract invariant computations outside the loop to minimize per-item overhead
