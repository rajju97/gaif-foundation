...
const ProductsPage = () => {
    ...
    // Performance Optimization: Wrap in useMemo to avoid recalculating on every re-render (e.g., when toggling sidebar).
    // Extracted .toLowerCase() conversions outside the filter loop to prevent redundant calculations on every product.
