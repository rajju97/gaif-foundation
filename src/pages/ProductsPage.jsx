...
const ProductsPage = () => {
    ...
    // ⚡ Bolt Optimization: Memoize the filtering and sorting of products
    // This prevents an O(n log n) operation from running on every single render
    // Also hoisting invariant toLowerCase() operations outside the loop saves redundant string allocations
        ...
        return products
            .filter(p => {
                ...
                const matchesCategory = selectedCategory === 'all' ||
                    (p.category && p.category.toLowerCase() === lowerSelectedCategory);
