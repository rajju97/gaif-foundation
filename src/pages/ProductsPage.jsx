...
const ProductsPage = () => {
    ...
    // 1. Wrapped derived state in useMemo to prevent recalculating on every render (e.g., when sidebarOpen toggles).
    // 2. Extracted invariant string operations (.toLowerCase()) outside the filter loop to avoid redundant operations.
