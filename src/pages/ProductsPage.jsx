...
const ProductsPage = () => {
    ...
    // ⚡ Bolt Optimization:
    // Memoize the filtering and sorting of products to prevent unnecessary recalculations on every render.
    // Hoist the invariant toLowerCase() conversions outside the filter loop to reduce per-item execution overhead.
