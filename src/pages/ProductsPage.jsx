...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Memoize filtered and sorted products to prevent expensive recalculations on every render
    const filteredProducts = useMemo(() => {
        // ⚡ Bolt: Extract loop invariants to avoid calling .toLowerCase() on every iteration
