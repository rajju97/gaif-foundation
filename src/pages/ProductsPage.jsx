...
const ProductsPage = () => {
    ...
    // Memoize the expensive filtering and sorting operation to prevent
    // re-calculation on every render unless dependencies change.
    // This reduces main thread blocking during re-renders, especially with large product lists.
