...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Wrapped in useMemo to prevent recalculating sorted/filtered lists on every render
    // ⚡ Bolt: Extracted invariant string conversions outside the loop to reduce per-item overhead
