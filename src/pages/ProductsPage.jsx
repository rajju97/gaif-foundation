...
const ProductsPage = () => {
    ...
    const filteredProducts = useMemo(() => {
        // Optimization: Extract invariant string operations outside the loop
        const lowerSearchQuery = (searchQuery || '').toLowerCase();
        const lowerSelectedCategory = selectedCategory === 'all' ? 'all' : (selectedCategory || '').toLowerCase();
        ...
        return products
            .filter(p => {
                ...
                const matchesCategory = lowerSelectedCategory === 'all' ||
